...
export function formatSupabaseError(e: unknown): string {
  if (e && typeof e === "object" && "message" in e) {
    const o = e as { message?: string; details?: string; hint?: string; code?: string; status?: number };
    if (typeof o.message === "string" && o.message.trim()) {
      ...
      if (typeof o.status === "number" && Number.isFinite(o.status)) parts.push(`HTTP ${o.status}`);
      return parts.join(" · ");
    }
  }
