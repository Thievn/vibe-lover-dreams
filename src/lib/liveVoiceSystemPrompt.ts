 ...
 * Used when `chatSessionMode === "live_voice"`; assistant replies are generated by the `grok-chat` Edge Function (Grok).
 * Typed/classic chat uses `together-chat` (Together Qwen2.5-72B-Instruct-Turbo).
 */
