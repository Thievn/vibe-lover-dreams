  ...
  if (menu) {
    if (styled) {
      const coherence =
        ...
        "\n\n**SHOT GEOMETRY (binding):** If the menu mentions lying, bent over, legs up, bathtub, beach, car, desk, bed, shower, bikini, towel, mirror selfie arm, etc., the final image must **show that configuration and setting clearly** — not a substitute “pretty woman standing at camera” shot.";
      return (
