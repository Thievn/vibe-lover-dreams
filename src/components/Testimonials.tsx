    ...
    <section className="py-16 px-4 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground text-sm">Join thousands already exploring their fantasies</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          ...
          <div className="rounded-xl border border-border bg-card/60 backdrop-blur-sm p-4 text-center">
            ...
            <p className="text-xl font-bold text-foreground">18K+</p>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="rounded-2xl border border-border bg-card p-5 relative">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mt-8 mb-3 italic">
