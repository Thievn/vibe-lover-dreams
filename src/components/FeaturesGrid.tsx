...
const features: Feature[] = [
  ...
  { icon: <Zap className="h-5 w-5" />, title: "Smart Device Control", description: "Real-time Lovense integration — your companion controls your devices", available: true },
  ...
  { icon: <Image className="h-5 w-5" />, title: "AI Image Generation", description: "Companions send custom-generated images during sessions", available: false },
  ...
  { icon: <Heart className="h-5 w-5" />, title: "Relationship System", description: "Companions develop feelings and relationship dynamics over time", available: false },
  ...
  { icon: <Globe className="h-5 w-5" />, title: "Multi-Language", description: "Companions speak your language — 20+ languages supported", available: false },
