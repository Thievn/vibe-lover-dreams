...
const rarityStyles: Record<Rarity, { border: string; glow: string; tag: string; tagBg: string }> = {
  Legendary: {
    ...
    glow: "shadow-[0_0_25px_hsl(45_100%_50%/0.35)]",
    tag: "text-yellow-400",
    tagBg: "bg-yellow-500/10 border-yellow-500/30",
  },
  Epic: {
  ...
  Rare: {
    ...
    glow: "glow-teal",
    tag: "text-cyan-400",
    tagBg: "bg-cyan-500/10 border-cyan-400/30",
  },
  Common: {
    border: "border-border",
    glow: "",
    tag: "text-muted-foreground",
    tagBg: "bg-muted border-border",
  },
};
                  ...
                  {placeholderCollection.map((card, i) => {
                    ...
                    return (
                      <motion.div
                        ...
                        style={{
                          boxShadow: card.rarity === "Legendary" ? rs.glow : card.rarity === "Epic" ? rs.glow : "",
                        }}
                      >
