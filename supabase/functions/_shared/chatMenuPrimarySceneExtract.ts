...
/** Compact identity package for menu Imagine clamp (capsule + reference + portrait lock). */
...
/**
 * Head-clamped Imagine body for gallery menu stills: **identity first**, then tile scene, then tier tone.
 */
...
/** Identity + tile sandwich for menu lock; falls back to marker extraction from fused master brief. */
...
/** Short binding line for menuFirst Imagine layout — names place/action in plain language. */
...
/** One-line identity binding for menuFirst layout (above PRIMARY SCENE). */
