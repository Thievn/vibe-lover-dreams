...
• **Forge live preview:** no visible areolas or nipples through sheer, wet, or tight fabric; no sexual acts or explicit anatomy — tease with pose, gaze, lighting, and **opaque or artfully covered** wardrobe only.
...
• Species & presentation: embrace originality — humans of any gender, non-binary glam, elves, vampires, angels, demons, werewolves, aliens, androids, merfolk, dragons, cosmic entities, anthro-inspired creatures, corrupted saints, mech-pilots, wasteland nomads, etc. Avoid generic stock-model sameness; vary silhouette, era, subculture, and facial storytelling.
• Passions & props: hint what they love — music, blades-as-jewelry, botany, street racing, alchemy, DJ decks, relic hunting, tea ceremony, orbital sports, antiquarian tomes, cooking, stargazing, courtroom drama, mech maintenance — as wardrobe or set dressing, not clutter.
...
• Anatomy must be **internally consistent with the forge body type and species** from Character Details (including non-human, hybrid, stylized, or exaggerated silhouettes). "Believable" means coherent for THAT design — not "rewrite into a default tall human runway model" when the UI label is anthro, monster-person, slime, hybrid, etc. Gender/presentation lines affect face, hair framing, and voice character — **not** base body shape: physique follows the body-type lock.
